        ...
        galleryImageClick = function galleryImageClickF(index) {
            return function (e) {
                ...
                function touchStart(event) {
                    ...
                    touchEnabled = true;
                    if (window.innerWidth === viewport && touchEnabled === true) {
                        touchPositionX = event.changedTouches[0].pageX;
                    }
                }
                function touchMove(event) {
                    // to check if touch event has already been triggerd
//                    if (touchEnabled) {
//                        return;
//                    }
//                    event.preventDefault ? event.preventDefault() : event.returnValue = false; // jshint ignore:line
                    var touch = event.touches[0] || event.changedTouches[0];
                    if (touchEnabled === false && window.innerWidth === viewport && event.length === 1) {
